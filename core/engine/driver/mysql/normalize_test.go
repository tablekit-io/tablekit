...
// fakeValuer implements driver.Valuer, unwrapping to a string — the shape some
// database/sql drivers use for wrapped column types.
...
func TestNormalizeValue(t *testing.T) {
	...
	tests := []struct {
		...
		{"valuer", fakeValuer{"123.456"}, "123.456", true, ""},
	}
