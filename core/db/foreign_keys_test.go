...
// TestForeignKeysMaterializedInDevelopment: when TABLE_KIT_ENV=development the
...
func TestForeignKeysMaterializedInDevelopment(t *testing.T) {
	t.Setenv("TABLE_KIT_ENV", "development")
